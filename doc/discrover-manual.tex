...
\end{description}
Note that the directional measures (\Q{mcc}, \Q{dlogl}, and \Q{dfreq}) require you to specify in which of the samples the motif is expected.
That is to say: you have to give a \Q{name} to your motif in the motif specification (see section~\ref{section:motif-specification}), and add \Q{name} to the list of \Q{names} given in a FASTA file specification (see section~\ref{section:fasta-specification}).
