...
The syntax for \plasma{} is nearly identical, except that motif specifications (section~\ref{section:motif-specification}) do not take \Q{insert} terms for \plasma{}.
...
If \Q{path} contains at least one colon, please prepend with colons to disambiguate.
...
The meaning of \Q{name}, \Q{indel}, and \Q{motifdef} are as follows:
...
\begin{description}
  ...
  \Item{Path to a file with a PWM}
...
If \Q{name} is not given given, all motifs are optimized with this score specification.
