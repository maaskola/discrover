...
The \discrover{} package also includes a Ruby script \verb|tikzlogo| that generates a \LaTeX{} document which uses \TikZ{} code to draw a sequence motif, and subsequently compiles the generated \LaTeX{} file into a PDF document.
