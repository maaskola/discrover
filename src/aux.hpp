...
std::vector<size_t> shift_positions_left(const std::vector<size_t> original_inserts, size_t shift);
std::vector<size_t> shift_positions_right(const std::vector<size_t> original_inserts, size_t shift, size_t maxp);
...
/** Convert a range of character specified by a pair of iterators to lower case. */
