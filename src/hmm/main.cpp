...
int main(int argc, const char** argv)
{
  ...
  eval_options.add_options()
    ...
    ("bestmotif", po::bool_switch(&options.evaluate.conditional_motif_probability), "During evaluation also print out the position of the best motif occurrence in each sequence.")
