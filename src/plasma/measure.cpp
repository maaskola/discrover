...
bool is_discriminative<Continuous::Measure>(Continuous::Measure measure) {
  if (measure == Continuous::Measure::Likelihood
      or measure == Continuous::Measure::Viterbi)
    return false;
  else
    return true;
}
...
void parse_measure(const string &token, Measure &measure) {
  ...
  */
    ...
    cout << "Deprecation warning: 'dme' has been renamed to 'dlogl'. Consider "
            "using that instead, as support for 'dme' will be removed in the "
            "future." << endl;
    measure = Measure::LogLikelihoodDifference;
    ...
    cout << "Deprecation warning: 'dips' has been renamed to 'dfreq'. Consider "
            "using that instead, as support for 'dips' will be removed in the "
            "future." << endl;
    measure = Measure::DeltaFrequency;
